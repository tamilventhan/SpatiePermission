<div>
    <!-- Sidebar navigation -->
    <div id="sidebar-section" class="h-screen fixed z-10">
        <div id="sidebar" class="fixed h-screen top-0 pt-18 left-0 bg-rose-500 w-14 hover:w-40 duration-500">
            <nav role="navigation" class="pl-2 pt-12 mt-4">
                <div class="mt-4 relative overflow-hidden">
                    {{-- <h1 class="name text-white fixed top-0 left-0 text-lg">CM</h1> --}}

                    <ul class="nav-list space-y-4" id="nav-list">
                        <li class="nav-item text-lg active p-2 rounded-l-xl text-white">
                            <a href="#home" class="flex gap-6 items-center">
                                <i class="bi bi-speedometer" style="font-size: 1.5rem;"></i>
                                
                                Home
                            </a>
                        </li>
                        <li class="nav-item text-lg p-2 rounded-l-xl text-white">
                            <a href="#about" class="flex gap-6 items-center">
                                <i class="bi bi-person-circle" style="font-size: 1.5rem;"></i>
                                About
                            </a>
                        </li>
                        <li class="nav-item text-lg p-2 rounded-l-xl text-white">
                            <a href="#service" class="flex gap-6 items-center">
                                <i class="bi bi-cart-check" style="font-size: 1.5rem;"></i>
                                Service
                            </a>
                        </li>
                        <li class="nav-item text-lg p-2 rounded-l-xl text-white">
                            <a href="#contact" class="flex gap-6 items-center">
